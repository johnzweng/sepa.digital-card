...
import digital.sepa.nfc.model.InfoKeyValuePair;
...
public class EmvUtils {
     ...
     * @param command
     * @param cmdData
     * @param lengthExpected the expected result length
     * @return
     */
     ...
     *
     * @param fileIdentifier identifier bytes
     * @return
     */
     ...
     *
     * @param shortEfFileIdentifier short id of the EF to read
    ...
    /**
     * @param days number of days after September 02, 1975 (what happened on this
     *             day?)
     * @return
     */
